...
if __name__ == "__main__":
    ...
    parser.add_argument("--local_dir", default="/cpfs01/user/zhoujiecheng/workload_rl_analyse/search-r1/data", help="Local directory to save the processed Parquet files.")
