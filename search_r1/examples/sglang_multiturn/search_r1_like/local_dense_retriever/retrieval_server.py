...
def retrieve_endpoint(request: QueryRequest):
    ...
    # Perform batch retrieval. Retriever implementations return only results
    # when return_score=False, so normalize both return shapes here.
    batch_output = retriever.batch_search(query_list=request.queries, num=request.topk, return_score=request.return_scores)
    if request.return_scores:
        results, scores = batch_output
    else:
        results, scores = batch_output, None
...
if __name__ == "__main__":
    ...
    parser.add_argument("--index_path", type=str, default="/mnt/shared-storage-user/ailab-sys/zhoujiecheng/aliyun_data/search_r1/local_dense_retriever/e5_Flat.index", help="Corpus indexing file.")
    parser.add_argument("--corpus_path", type=str, default="/mnt/shared-storage-user/ailab-sys/zhoujiecheng/aliyun_data/search_r1/local_dense_retriever/wiki-18.jsonl", help="Local corpus file.")
