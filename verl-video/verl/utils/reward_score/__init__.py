...
def _default_compute_score(data_source, solution_str, ground_truth, extra_info=None, sandbox_fusion_url=None, concurrent_semaphore=None):
    ...
    elif data_source in ["HuggingFaceM4/the_cauldron", "nvidia/Cosmos-Reason1-RL-Dataset", "/cpfs01/user/zhoujiecheng/workload_rl_analyse/verl-video/data/Cosmos-Reason1-RL-Dataset/"]:
        from . import cauldron

        res = cauldron.compute_score(solution_str, ground_truth)
    else:
