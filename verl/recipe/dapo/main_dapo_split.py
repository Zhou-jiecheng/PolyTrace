...
from .dapo_ray_trainer_split import RayDAPOTrainer
...
class TaskRunner:
    def run(self, config):
        ...
        resource_pool_spec = {
            actor_pool_id: [int(config.actor_rollout_ref.n_training_gpu_per_node)] * config.trainer.nnodes,
            rollout_pool_id: [int(config.trainer.n_gpus_per_node - config.actor_rollout_ref.n_training_gpu_per_node)] * config.trainer.nnodes,
        }
        mapping = {
        ...
        #     mapping[Role.RefPolicy] = rollout_pool_id
