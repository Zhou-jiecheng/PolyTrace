...
class Tracking:
    ...
    def __init__(self, project_name, experiment_name, default_backend: Union[str, List[str]] = "console", config=None):
        ...
        if "tracking" in default_backend or "wandb" in default_backend:
            ...
            wandb.init(project=project_name, name=experiment_name, config=config, settings=wandb.Settings(init_timeout=120))
        ...
        if "console" in default_backend:
            ...
            # Console logs are usually used for live training progress. Keep
            # stdout/stderr line-buffered when the runtime supports it so each
            # Tracking.log call is visible as soon as the step finishes.
